    ...
    <div className="min-h-screen bg-neutral-50 animate-fade-in">
      ...
      <div className="relative w-full h-64 sm:h-72 md:h-80">
        ...
        <div className="absolute top-4 right-4 sm:top-6 sm:right-6">
          <button className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-white/30 text-white text-sm font-medium bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-colors">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 md:p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-white/80 text-sm mb-3">{trip.country}</p>
